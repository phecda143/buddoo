...
class ProfileForm(FlaskForm):
    ...
    gender = SelectField('Пол', choices=[('male', 'Мужской'), ('female', 'Женский'), ('hide', 'Скрыть')], validators=[InputRequired()])
...
def my_form():
    ...
    image_file = profile.picture if profile and profile.picture else url_for('static', filename='profile_pics/' + 'None.png')
...
def all_forms():
    ...
    return render_template('all_forms.html', profiles=profiles)
